...
$tday=new DateTime(date("d-m-y"));
  $tday2=new DateTime(date("d-m-y",strtotime("+7 date")));
  $ttday=$tday->format('d-m-y');
  $ttday2=$tday2->format('d-m-y');
$querry1="SELECT * FROM user_details WHERE username='$uname'";
$result1=mysqli_query($conn,$querry1);
if(mysqli_num_rows($result1)>0){
  echo "<script> alert('username exists'); </script>";
}
else{
$sql="INSERT INTO user_details(username,password,name,email,phone_no,role) VALUES('$uname','$pass1','$nam','$ema','$pho',0)";
...
<form method="POST" action="">
  <div class="input-group">
    ...
    <div class="input-group">
    <label>Email</label>
    <input type="email" name="ema" value="" required>
  </div>

  <div class="input-group">
    <label>Phone Number</label>
    <input type="text" name="phnno" value="" required>
  </div>
	<div class="input-group">
  ...
  <p id="length" class="invalid">Minimum <b>8 characters</b></p>
	...
	<div class="input-group" align="center">
		<button type="submit" class="btn" name="register_btn" onclick="return Validate()" >Register</button>
	</div>
</form>
...
var myInput2 = document.getElementById("password_1");
