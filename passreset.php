...
$pass1=password_hash($newpwd, PASSWORD_BCRYPT);
...
{
  $pass=$row['password'];
  if(password_verify($oldpwd,$pass)){
    $q="UPDATE user_details SET password='$pass1' where username='$uname'";
...
<body>
  <div class="header">
<center>Password Reset System</center>
</div>
